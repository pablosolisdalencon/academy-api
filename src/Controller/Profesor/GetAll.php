...
final class GetAll extends Base
{
    public function __invoke(
        ...
        $profesores = $this->getServiceFindProfesor()
            ->getProfesoresByPage((int) $page, (int) $perPage, $name, $description);

        return $this->jsonResponse($response, 'success', $profesores, 200);
    }
}
